...
static char *rid_str[] ={
  ...
  "RID_ASM",        "RID_TYPEOF",   "RID_ALIGNOF",  "RID_ATTRIBUTE",  "RID_VA_ARG",
  "RID_EXTENSION", "RID_IMAGPART", "RID_REALPART", "RID_LABEL", "RID_CHOOSE_EXPR",
  "RID_TYPES_COMPATIBLE_P", "RID_DFLOAT32", "RID_DFLOAT64", "RID_DFLOAT128",
  ...
  "RID_STATCAST",   "RID_HAS_NOTHROW_ASSIGN",       "RID_HAS_NOTHROW_CONSTRUCTOR",
  "RID_HAS_NOTHROW_COPY",  "RID_HAS_TRIVIAL_ASSIGN",   "RID_HAS_TRIVIAL_CONSTRUCTOR",
